  ...
  return (
    <div>
      ...
      <div className="subtitle">
        <p>Lg Fairmont maintains an intense and rigorous hiring process thus our clients can be assured that they areworking with a professional of the highest skill and integrity. Our agents are highly credentialed and haveachieved law, master degrees, and MBA degrees.</p>
